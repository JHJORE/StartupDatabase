...
def get_company_count(db: Session):
    return db.query(models.Company.OrgNumber).count()

def search_Companies(db: Session, CompanyName: str, Municipality: str, Sector: int, EmployeesMin: int, EmployeesMax: int, skip: int = 0, limit: int = 100):
