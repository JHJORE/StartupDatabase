...
class HomePage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        btn = customtkinter.CTkButton(top_frame, command= lambda : controller.show_frame(HomePage))
        btn.grid(row=0, column=0, columnspan=1, pady=10, padx=10, ipadx= 30) 
            #Scrollbar and tex
        ...
        cas = FilesView(root, root, textbox)
